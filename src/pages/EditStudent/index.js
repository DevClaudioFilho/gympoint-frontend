  ...
  return (
    <Container>
      ...
      <InputContainer>
          ...
          <InfosBoby>
            <Input type="number" name="age" label="Idade"  placeholder={`${students.age}`}/>
            <Input type="number" name="weight" label="Peso (em kg)" placeholder={`${students.weight}`} />
            <Input type="number" name="height" label="Altura" placeholder={`${students.height}`} />
          </InfosBoby>
      </InputContainer>
      </Form>
    </Container>
